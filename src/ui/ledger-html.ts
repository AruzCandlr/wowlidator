...
var ADV_GROUPS = [
  ...
  ['Behaviour', ['no-heal', 'no-agent', 'no-agent-early-stop', 'no-reconstruct', 'no-network', 'no-history', 'quarantine-flaky', 'update-baselines', 'no-author-review', 'no-agent-capture', 'no-value-resolution', 'author-mode', 'concurrency', 'author-concurrency', 'author-attempts', 'sheet-order', 'db-baseline']],
